...
class StyleService:
    ...
    def info_card_for_course(course_info):
        more_info_card = (ui.div(
                                ...
                                ui.div("name: ", course_info.name),
                                ui.div("id: ", course_info.id),
                                ui.div("Credits: ", course_info.credits),
                                ui.div("degree_ids: ", course_info.degree_ids),
                                ui.div("years: ", course_info.years),
                                ui.div("Themes: ", ", ".join(course_info.themes)),
                                ui.div("prog lang: ", course_info.prog_lang),
